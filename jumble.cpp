...
void testJumble() {
	...
	// Black Box testing of public accessors and exceptions thrown when constructing puzzle
	cout << "Added Unit Tests: " << endl;

	//COMMENTED OUT WHEN TESTING OTHER COMPONENTS

	//cout << "Test input size error:" << endl;
	//JumblePuzzle myJP("waytoolonginput", "easy");
	//cout << "Test incorrect input error: " << endl;

	//JumblePuzzle otherJP("noout", "nope");

	cout << "Test accessor functions:" << endl;

	JumblePuzzle realJP("OUTPUT", "medium");
	showJumble(realJP.getJumble(), realJP.getSize());
	cout << "Test getSize(): " << realJP.getSize() << endl;
	cout << "Test getRowPos():" << realJP.getRowPos() << endl;
	cout << "Test getColPos(): " << realJP.getColPos() << endl;
	cout << "Test getDirection(): " << realJP.getDirection() << endl;
